    ...
    render() {
        ...
        return (
            <Card style={{ color: 'white' }} className="bg-dark" key={"userId"}>
                <Card.Img style={{ height: '20rem', width: 'auto', objectFit: 'cover', position: 'relative' }} variant="top" src={currentUser.currentUser?.imageSource ? currentUser.currentUser.imageSource : "https://www.cooperhewitt.org/wp-content/uploads/2018/07/20914_472d45b4ae377c5f_b1.jpg"} /> 
                <Card.ImgOverlay >
